            ...
            <div className="block" key={field.name}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={
                    isEntryForm
                      ? "min-h-13 w-full rounded-xl border border-[#f0e6d8] bg-transparent py-3 pr-12 pl-12 text-base text-[#2d2d2d] transition-[border-color,box-shadow] duration-150 outline-none placeholder:text-[#aaaaaa] focus:border-[#cd9255] focus:ring-4 focus:ring-[#cd9255]/12"
