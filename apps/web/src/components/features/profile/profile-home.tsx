...
export function ProfileHome({
  ...
  return (
    <main className="animate-page-enter mx-auto flex min-h-dvh w-full max-w-[393px] flex-col bg-[#fdf8f2] pb-[max(6rem,env(safe-area-inset-bottom))] text-[#2d2d2d] shadow-xl shadow-stone-900/5">
